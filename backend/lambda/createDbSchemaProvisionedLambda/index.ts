...
export const handler = async () => {
    ...
    try {
        ...
        const tablesToDrop = [
            'health_recommendation_provisioned_lambda',
            'air_quality_index_provisioned_lambda',
            'pollutant_concentration_provisioned_lambda',
            'aq_records_provisioned_lambda',
            'tiles_provisioned_lambda',
            'postcode_areas_provisioned_lambda',
            'zones_provisioned_lambda',
            'boroughs_provisioned_lambda',
            'aggregate_state_provisioned_lambda', 
            'regional_aggregates_provisioned_lambda'
        ];
        ...
        await client.query(`
            CREATE TABLE IF NOT EXISTS boroughs_provisioned_lambda (
        ...
        await client.query(`
            CREATE TABLE IF NOT EXISTS zones_provisioned_lambda (
                id SERIAL PRIMARY KEY,
                name VARCHAR(255) NOT NULL, 
                location POINT NOT NULL, 
                inserted_at TIMESTAMP NOT NULL, 
        ...
        await client.query(`
            CREATE TABLE IF NOT EXISTS postcode_areas_provisioned_lambda (
                id SERIAL PRIMARY KEY,
                name VARCHAR(255) NOT NULL, 
                location POINT NOT NULL, 
                inserted_at TIMESTAMP NOT NULL, 
        ...
        await client.query(`
            CREATE TABLE IF NOT EXISTS tiles_provisioned_lambda (
                id SERIAL PRIMARY KEY,
                /* borough_id INT REFERENCES boroughs_provisioned_lambda(id), */
                borough_id INT, 
                /* zone_id INT REFERENCES zones_provisioned_lambda(id), */ 
                zone_id INT, 
                /* postcode_area_id INT REFERENCES postcode_areas_provisioned_lambda(id), */
        ...
        await client.query(`
            CREATE TABLE IF NOT EXISTS aq_records_provisioned_lambda (
                id SERIAL PRIMARY KEY,
        ...
        await client.query(`
            ...
            ON aq_records_provisioned_lambda(tile_id, timestamp DESC, ingestion_timestamp DESC);
        `);

        await client.query(`
            CREATE TABLE IF NOT EXISTS pollutant_concentration_provisioned_lambda (
                id SERIAL PRIMARY KEY,
                record_id INT REFERENCES aq_records_provisioned_lambda(id),
                /* tile_id INT REFERENCES tiles_provisioned_lambda(id), */
                tile_id INT NOT NULL,
                timestamp TIMESTAMP NOT NULL,
                ingestion_timestamp TIMESTAMP NOT NULL,
        ...
        await client.query(`
            CREATE TABLE IF NOT EXISTS air_quality_index_provisioned_lambda (
                id SERIAL PRIMARY KEY,
                record_id INT REFERENCES aq_records_provisioned_lambda(id),
                /* tile_id INT REFERENCES tiles_provisioned_lambda(id), */
                tile_id INT NOT NULL,
        ...
        await client.query(`
            ...
            ON air_quality_index_provisioned_lambda(record_id);
        `);

        await client.query(`
            CREATE TABLE IF NOT EXISTS health_recommendation_provisioned_lambda (
                id SERIAL PRIMARY KEY,
                record_id INT REFERENCES aq_records_provisioned_lambda(id),
                /* tile_id INT REFERENCES tiles_provisioned_lambda(id), */
                tile_id INT NOT NULL,
        ...
        if (boroughs.length > 0) {
            ...
            // Run query
            await client.query(
                `INSERT INTO boroughs_provisioned_lambda (id, name, region, location, inserted_at, updated_at, description) VALUES ${valuesClause}`,
                params
            );
        ...
        const valuesClause = tiles
            ...
            await client.query(
                `INSERT INTO tiles_provisioned_lambda (id, borough_id, zone_id, postcode_area_id, name, location, inserted_at, updated_at, description) VALUES ${valuesClause}`,
                params
            );
        ...
        await client.query(`
            CREATE TABLE IF NOT EXISTS regional_aggregates_provisioned_lambda (
                id SERIAL PRIMARY KEY,
        ...
        await client.query(`
            ...
            ON regional_aggregates_provisioned_lambda(level, region_id);
        `);

        // Aggregate state table (tracks last processed timestamp)
        await client.query(`
            CREATE TABLE IF NOT EXISTS aggregate_state_provisioned_lambda (
                id SERIAL PRIMARY KEY,
                level VARCHAR(20) NOT NULL,
        ...
        await client.query(`
            ...
            ON aggregate_state_provisioned_lambda(level);
        `);
